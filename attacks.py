...
def fgsm_targeted(x, predictions, x_original, eps, back='tf', clip_min=None, clip_max=None, target_class = 0):
    if back == 'tf':
        # Compute FGSM using TensorFlow
        from attacks_tf import fgsm_targeted as fgsm_targeted_tf
        return fgsm_targeted_tf(x, predictions, x_original, eps, clip_min=clip_min, clip_max=clip_max, target_class = target_class)
